...
Provenance will be completed after generation with the factory image model, generation date, reviewed candidate, source prompt sidecar, and optimized derivatives. Generated imagery is disclosed in the site footer.
